...
def invoke_balance_transfer(receiver, sender, token, channel_name, chaincode_name, org):
    url = "http://{}:{}/channels/{}/chaincodes/{}".format(server, port, channel_name, chaincode_name)
    auth = "Bearer " + token
    headers = {"authorization": auth, "content-type": "application/json"}
    data = {"peers": ["peer0.org1.example.com","peer0.org2.example.com"], 
        "fcn":"move",
        "args":[receiver, sender, "0"]}
    print("Invoke balance transfer")
    response = requests.post(url, headers=headers, json=data)
    print(response.text)
...
if __name__ == "__main__":
    ...
    # token_org1 = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2OTM5NzE5NTMsInVzZXJuYW1lIjoidGVtcCIsIm9yZ05hbWUiOiJPcmcxIiwiaWF0IjoxNjkzOTM1OTUzfQ.x06zMn-c0_e7_phfc3thS30R1H284V8x6xMda6rl6Ak"
    # token_org2 = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2OTM5NzE5NTMsInVzZXJuYW1lIjoidGVtcCIsIm9yZ05hbWUiOiJPcmcyIiwiaWF0IjoxNjkzOTM1OTUzfQ.KUXCZIxM9pQI9FIayWjpjILY3MICgyeZ5YT3n5SKpAI"
    


    token_org1, token_org2 = initialize_network()
    print("token1 : ", token_org1)
    print("token2 : ", token_org2)
    # if org == "Org1":
    #     token = token_org1
    # elif org == "Org2":
    #     token = token_org2
